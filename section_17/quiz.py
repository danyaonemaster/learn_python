...
score = 0
questions_answers=[]
questions_answers.append(["In Terraria you can tame a bee as a pet.", "T"])
questions_answers.append(["In Expert mode, bosses have less health than in Normal mode.", "F"])
